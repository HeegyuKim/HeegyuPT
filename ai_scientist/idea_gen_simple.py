...
idea_eval_prompt = """{task_description}

Here are the ideas for research experiments and directions:
'''
Title: {title}
...
In <THOUGHT>, first carefully consider the quality, novelty, and feasibility of the idea.
...
def generate_ideas(
    ...
    idea_str_archive = seed_ideas

    idea_system_prompt = SYSTEM
        ...
        for j in range(max_num_iterations):
            try:
                ...
                if "decision made: not novel" in text.lower():
                    ...
                    idea["novelty_assessment"] = text
                    idea["similar_papers"] = papers_str
                    break
